			...
			<Html lang='en'>
				<Head>
					...
					<link
						...
						href='/icons/splash_screens/iPhone_14_Pro_Max_landscape.png'
					/>
					<link
						rel='apple-touch-startup-image'
						media='screen and (device-width: 393px) and (device-height: 852px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)'
						href='/icons/splash_screens/iPhone_14_Pro_landscape.png'
					/>
					<link
						rel='apple-touch-startup-image'
					...
					<link
						...
						href='/icons/splash_screens/iPhone_14_Pro_Max_portrait.png'
					/>
					<link
						rel='apple-touch-startup-image'
						media='screen and (device-width: 393px) and (device-height: 852px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)'
						href='/icons/splash_screens/iPhone_14_Pro_portrait.png'
					/>
					<link
						rel='apple-touch-startup-image'
